--------------------------------------------------------
--  File created - Thursday-March-12-2020   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TYPE "T3"."HEADER_OBJ" FORCE is OBJECT (
    ...
    SHIFT               VARCHAR2(255),
    SCHEDULE_DATE_START VARCHAR(255),
    SCHEDULE_DATE_END   VARCHAR(255),
    IS_NEW              NUMBER(10),
    IS_CHANGED          NUMBER(10)
);
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "T3"."DOWNTIME_TYPES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_ACTIVITY_DETAILS_PK_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "T3"."TBL_ACTIVITY_DETAILS_PK_SEQ"  MINVALUE 1 MAXVALUE 999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_ACTIVITY_DOWNTIME_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "T3"."TBL_ACTIVITY_DOWNTIME_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_ACTIVITY_PK_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "T3"."TBL_ACTIVITY_PK_SEQ"  MINVALUE 1 MAXVALUE 9999999999 INCREMENT BY 1 START WITH 321 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence TBL_HEADER_PK_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "T3"."TBL_HEADER_PK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 221 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "T3"."TBL_MATERIAL_PK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999 INCREMENT BY 1 START WITH 161 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (121,500,1,500,500,0,'remarks',1,to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'1231313',181);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (122,500,1,500,500,0,'remarks',1,to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'1231313',181);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (141,1,50,100,204,0,'remarks',null,to_date('09-MAR-2020 09:00:37','DD-MON-YYYY HH24:MI:SS'),to_date('09-MAR-2020 09:00:42','DD-MON-YYYY HH24:MI:SS'),'TBB143ASCN',144);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (142,1,50,100,204,0,'remarks',null,to_date('09-MAR-2020 09:01:39','DD-MON-YYYY HH24:MI:SS'),to_date('09-MAR-2020 09:01:42','DD-MON-YYYY HH24:MI:SS'),'TBXLC28BOS',144);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (143,1,1,5000,2550,0,'remarks',null,to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'TL124BKBOS',144);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (144,1,1,5000,2550,8,'remarks',null,to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'UC936A1BOS',144);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (145,1,25,200,102,0,'remarks',null,to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'VC142AHHBP',144);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (146,1,50,100,204,0,'remarks',null,to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('09-MAR-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'VC142CKBOS',144);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (65,500,1,500,500,0,'remarks',1,to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'1231313',143);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (66,500,1,500,500,0,'remarks',1,to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'1231313',143);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (67,1,1,5000,2550,0,'remarks',1,to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'30144AN----XF',144);
Insert into T3.TBL_MATERIAL (ID,QUANTITY,STANDARD,REQUIREMENTS,USED,REJECT,REMARKS,LAST_UPDATED_BY,DATE_ENTERED,DATE_UPDATED,MATERIAL_CODE,HEADER_ID) values (68,25,25,200,102,0,'remarks',1,to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),to_date('29-FEB-2020 00:00:00','DD-MON-YYYY HH24:MI:SS'),'TBA143ASCN',144);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "T3"."SYS_C006997" ON "T3"."DEPT" ("DEPTNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "T3"."SYS_C006999" ON "T3"."EMP" ("EMPNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT DOWNTIME_TYPES_SEQ.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
    ...
    BEGIN
        if obj_header.IS_NEW = 1 then
            ...
            VALUES ( obj_header.ID                  
                    , obj_header.BARCODE             
                    , obj_header.ACTUAL_START        
                    , obj_header.ACTUAL_END          
                    , obj_header.STATUS              
                    , obj_header.PO_NUMBER           
                    , obj_header.CONTROL_NUMBER      
                    , obj_header.SHIPPING_DATE       
                    ...
                    , obj_header.SHIFT
                    , obj_header.SCHEDULE_DATE_START
                    , obj_header.SCHEDULE_DATE_END
