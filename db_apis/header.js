...
DECLARE
    ...
    ACTIVITIES  T3.T3_PACKAGE.ACTIVITY_COLLECTION   := T3.T3_PACKAGE.ACTIVITY_COLLECTION();
    MANPOWER    T3.T3_PACKAGE.MANPOWER_COLLECTION   := T3.T3_PACKAGE.MANPOWER_COLLECTION();
    MATERIALS   T3.T3_PACKAGE.MATERIAL_COLLECTION   := T3.T3_PACKAGE.MATERIAL_COLLECTION();
